export interface SmartContractInterface {
    ...
    internalGetSignal(address: string, index: number): Promise<SignalResponseInterface>
    getProofLen(address: string): Promise<number>
    internalGetProofLen(address: string): Promise<number>
    ...
    internalGetPeriodProofs(address: string, index: number): Promise<PeriodProofResponseInterface>
